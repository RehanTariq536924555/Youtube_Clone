...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    constructor(configService) {
        const secret = configService.get('jwt.secret') || process.env.JWT_SECRET || '5YrmFRKZSFLiWc23dh4LNHLkvHALQYchjTjP82jpDybhm';
        console.log('🔑 JWT Strategy initialized');
        console.log('🔑 JWT Secret from config:', configService.get('jwt.secret') ? 'Found' : 'Not found');
