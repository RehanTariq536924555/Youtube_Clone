...
let AuthController = class AuthController {
    ...
    async getCurrentUser(req) {
        try {
            ...
            console.log(...oo_oo(`262640201_126_4_126_61_4`, 'GET /auth/me - User ID from token:', userId));
            console.log(...oo_oo(`262640201_127_4_127_58_4`, 'GET /auth/me - Full req.user:', req.user));
            const user = await this.usersService.findById(userId);
            if (!user) {
                console.error(...oo_tx(`262640201_131_6_131_61_11`, 'GET /auth/me - User not found:', userId));
                return { error: 'User not found' };
            }
            console.log(...oo_oo(`262640201_135_4_139_6_4`, 'GET /auth/me - User found:', {
                id: user.id,
                email: user.email,
                role: user.role
            }));
            ...
            console.log(...oo_oo(`262640201_154_4_154_81_4`, 'GET /auth/me - Sending response:', JSON.stringify(responseData)));
            return responseData;
        }
        catch (error) {
            console.error(...oo_tx(`262640201_158_4_158_57_11`, 'GET /auth/me - Error:', error.message));
    ...
    async googleVerifyCredential(body) {
        try {
            ...
            console.error(...oo_tx(`262640201_262_4_262_66_11`, 'Google credential verification failed:', error));
            return {
