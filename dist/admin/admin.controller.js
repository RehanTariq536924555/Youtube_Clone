...
let AdminController = class AdminController {
    ...
    async getAllVideos(page = 1, limit = 20, status) {
...
__decorate([
    (0, common_1.Put)('videos/:id/feature'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "featureVideo", null);
__decorate([
    (0, common_1.Put)('videos/:id/suspend'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('reason')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "suspendVideo", null);
__decorate([
    (0, common_1.Put)('videos/:id/unsuspend'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "unsuspendVideo", null);
__decorate([
...
__decorate([
    (0, common_1.Put)('users/:id/change-password'),
    __param(0, (0, common_1.Param)('id')),
