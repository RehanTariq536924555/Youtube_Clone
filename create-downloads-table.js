  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS downloads (
        ...
        CONSTRAINT fk_downloads_user FOREIGN KEY ("userId") REFERENCES "user"(id) ON DELETE CASCADE,
        CONSTRAINT fk_downloads_video FOREIGN KEY ("videoId") REFERENCES video(id) ON DELETE CASCADE,
        CONSTRAINT unique_user_video_download UNIQUE ("userId", "videoId")
      );
    `);
    ...
    await client.query(`
      CREATE INDEX IF NOT EXISTS idx_downloads_video ON downloads("videoId");
    `);
    console.log('✅ Index created on videoId');

    console.log('\n🎉 Downloads feature database setup complete!');
  } catch (error) {
