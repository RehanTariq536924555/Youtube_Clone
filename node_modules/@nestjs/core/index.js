"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\hp\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.443\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '20db1af8282d4c34ae2ae4VVIfVUgKCFwDUA1bAwJQAABXAwBT', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/hp/.vscode/extensions/wallabyjs.console-ninja-1.0.443/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20db1af8282d4c34ae2ae4VVIfVUgKCFwDUA1bAwJQAABXAwBT', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
